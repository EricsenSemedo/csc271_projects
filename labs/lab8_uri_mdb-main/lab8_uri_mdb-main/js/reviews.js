...
*/
var reviewUsernames = ['user1', 'user2', 'user3'];
var reviewDates = ['2024-10-30', '2024-11-30', '2024-9-25'];
var reviewTexts = ['This movie was great!', 'This movie was terrible!', 'This movie was okay.'];
var reviewRatings = [5, 1, 3];
...
for (var i = 0; i < reviewCards.length; i++) {
	reviewCards[i].querySelector('.review-rating');
}
